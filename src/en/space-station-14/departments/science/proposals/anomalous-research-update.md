...
-	Anomalous infections will also need to be reworked to account for the changes proposed here. One possibility is to have a risk of infection when a player is in prolonged contact with high-quality rifts (knowingly or not). In this case, it would also be a responsibility of the science team to periodically collapse rifts in high-traffic areas that they don't intend to use for research purposes, to reduce the risk of crew infection. Further discussion on the matter is warranted.
