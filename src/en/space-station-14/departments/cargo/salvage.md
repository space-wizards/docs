...
## Concept
The Salvage sub-department is a substantial part of the Cargo department's resource generation, acting as the most economic way to provide large quantities of raw materials to the station that would otherwise be costly or difficult to acquire. It draws heavily from the traditional "sci-fi industrial materials-handling" aesthetics; mining valuable asteroids, breaking down structures into scrap, and dangerous zero-g work in space. Salvage should appeal to players who seek to min-max efficiency in their work, challenging players on how to generate as much value for the station as possible with the time and resources they have. While Salvage's theming and duties necessitates not working inside of the station proper, this should not translate into Salvage being fully independent or disappearing from the station (and therefore the round) for extended periods of time.
...
- Mutual collaboration with the station; the department provides, and is provided to in return.
- PvE presesence; Salvage gameplay explores the PvE system as part of its gameplay loops. 
- Good for medium-and-up ranges of player experience.

## Responsibilities
- Salvage is very efficient at providing resources other departments can make use of. While Cargo should be able to function somewhat without Salvage, but if Salvage does its job Cargo can feel free to spend their resources elsewhere.
...
- Work consists of dangerous conditions.
  - Salvage gameplay should feature hazards that Salvagers have to navigate around and be mindful of. This heightens the stakes of performing the work and works as a trade-off for the high rewards Salvage can provide to the station.
...
- Isolationism.
  ...
  - When possible, highjack the desire for progression with complementary systems enable collaborative gameplay. Implement feedback loops that encourage Salvage to collaborate with the station and not constantly hover on the outside.
- Tools and equipment translates to highly effective in PvP.
...
- Steamrolling resource generation.
  - The amount of resources Salvage is able to generate shouldn't so massive as to completely invalidate resource management and regular Cargo gameplay tasks, while poor Salvage performance shouldn't be so debilitating that the rest of the station is unable to function. The range of Salvage's impact should primarily be within Cargo; a great Salvage teams lets Cargo feel like it is flourishing, while a bad/non-existent Salvage team forces Cargo to allocate resources to getting materials via other means.
