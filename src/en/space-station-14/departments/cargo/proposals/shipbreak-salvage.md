...
In terms of what resources Salvage should be able to uniquely supply to the station, this document primarily cites rare materials. With the content currently available this can negatively impact gameplay for other departments (e.g Science) where Salvage is _required_ to provide materials to enable core gameplay and rewards. The design of BreakSalv is such that new materials and equipment could be introduced as new wreck resources, to make poor/non-existent Salvage work less blocking for other roles. As this would involve a larger rework of the overall resource system in the game with content supporting it, and that it does not impact BreakSalv's core gameplay loop, it is left out of this design proposal.
