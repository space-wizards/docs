...
Traders have in-built flash protection, to prevent them from ever becoming a revolutionary.
...
There is exactly one specific interaction traders have with antagonists: their machines can be broken into with an Authentication Disrupter, which gives everyone access to their contents.
...
Although they are free to sell this to anyone aboard the station, since they are not crew, they can potentially be banned from selling at the station if they make too many risky deals. So, there's nothing mechanically keeping you from selling that EMAG to a scientist head revolutionary ... but if that revolution goes south and your deal gets traced, well, you're now a criminal.

### Optional Feature: Theivin' Traders
In this feature, a separate ghost role for an antagonistic trader would sometimes appear. This trader would spawn with (item-only) theif objectives, the pickpocketing ability, and the pacifism implant. They would have to accomplish their objectives without any of the theif's original tools ... but with the full power of their shop's random inventory and their business skills. Every man has his price, right?
