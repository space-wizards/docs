...
- Ideally, armories are mapped with a suit storage for every hardsuit, rather than having some just sitting on a rack, though as long as there are one or two storages it would still suffice.
