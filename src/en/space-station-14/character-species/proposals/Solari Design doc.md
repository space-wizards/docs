\# Solari Species Document

\| Designers \| Coders \| Implemented \| GitHub Links \|
\|\-\--\|\-\--\|\-\--\|\-\--\| \| Spirita \| TBD \|

\## Overview This design document covers Solari as a round-start
species. Solari are a humanoid race that is perpetually on fire which is
the focus point of most of their mechanics. It is a race intended to be
a bit more difficult similarly to vox. Based on novakids from starbound

\## Background Solari are based upon the idea of SS13s plasma people but
...
pokemon and flame princess from adventure time aswell as the already
...
and see around. Slowly overtime they will howver die to cold damage
...
\### Core Visual Elements Solari are a humanoid species that use neon
lighting (Light interior, darker border.) with hair that stands at ends
...
Solari naming conventions are pretty flexible. Their name should contain
a reference to chemistry and or physics, words related to light work
nicely for example.

Some examples of Solari names include: Hannah Hexafluorine, Argon John,
Luna Sol, Fred Frezon, Nancy Neutron etc.

\### Features Of The Species

\#### Stoking Solari are constantly on fire thus needing fuel. They
already breathe in oxygen from the air however they need more aid then
...
also accumlate oxygen loss alongside cold damage. Other players can also
use water to decrease the stoke level on solari.

\#### Unique Bloodstream Solari can not use normal blood instead they
have blood that has been \"plasmafied\" there blood can be centirifuged
for liquid plasma if worse comes to worse. Instead of saline medical
doctors can seek to use liquid plasma to replinish their blood.
...
\#### Air The solari breathe oxygen at a rate of 2x due to their
