...
- Large new features and comprehensive reworks to existing large features (ie antags anything that could be considered a subdepartment unto itself), should first be [proposed and accepted in abstract](../tips/proposal-guidelines.md) before you start working on actually implementing it.
