...
**Breaking any of these rules will result in disciplinary action being taken**
...
- Maintainers should keep public criticism of code *constructive* and avoid making comments in regards to the authors of the code. **Harsh but fair** criticism of code is *acceptable*, but criticism of its author is not.
...
- If there is a conflict around game design between something in the docs and someone's idea, what is detailed in the documentation takes precedent. If a change to specific documentation is required, it should be discussed with the respective work group, and any necessary changes should be made to the documentation.
